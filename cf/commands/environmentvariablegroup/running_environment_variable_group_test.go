...
var _ = Describe("running-environment-variable-group command", func() {
	...
	BeforeEach(func() {
		command_registry.Register(&environmentvariablegroup.RunningEnvironmentVariableGroup{})
		ui = &testterm.FakeUI{}
	...
	AfterEach(func() {
		command_registry.Commands.RemoveCommand("running-environment-variable-group")
	})
