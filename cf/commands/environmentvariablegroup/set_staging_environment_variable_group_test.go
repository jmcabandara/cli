...
var _ = Describe("set-staging-environment-variable-group command", func() {
	...
	BeforeEach(func() {
		command_registry.Register(&environmentvariablegroup.SetStagingEnvironmentVariableGroup{})
		ui = &testterm.FakeUI{}
	...
	AfterEach(func() {
		command_registry.Commands.RemoveCommand("set-staging-environment-variable-group")
	})
