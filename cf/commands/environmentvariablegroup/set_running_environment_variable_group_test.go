...
var _ = Describe("set-running-environment-variable-group command", func() {
	...
	BeforeEach(func() {
		command_registry.Register(&environmentvariablegroup.SetRunningEnvironmentVariableGroup{})
		ui = &testterm.FakeUI{}
	...
	AfterEach(func() {
		command_registry.Commands.RemoveCommand("set-running-environment-variable-group")
	})
